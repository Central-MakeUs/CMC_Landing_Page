...
export const SESSION_ROWS: { label: string; value: string }[] = [
  ...
  { label: '최종 팀 빌딩', value: '2026.05.23' },
  { label: '1차 모각작', value: '2026.05.23' },
  { label: '2차 모각작', value: '2026.05.23' },
  { label: '런칭데이', value: '2026.05.23' },
  { label: '데모데이', value: '2026.05.23' },
  { label: '종무식', value: '2026.05.05' },
]
